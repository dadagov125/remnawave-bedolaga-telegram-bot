...
class BotConfigurationService:
    ...
    CATEGORY_KEY_OVERRIDES: dict[str, str] = {
        ...
        'PHONE_AUTH_ENABLED': 'PHONE_AUTH',
        'PHONE_AUTH_PROVIDER': 'PHONE_AUTH',
        'PHONE_AUTH_API_KEY': 'PHONE_AUTH',
        'PHONE_AUTH_RATE_LIMIT_PER_HOUR': 'PHONE_AUTH',
        'PHONE_AUTH_ALLOWED_COUNTRY_CODES': 'PHONE_AUTH',
